...
import com.hason.dtp.account.point.RmAccountPointApplication;
 ...
 */
@Configuration
@EntityScan(basePackageClasses = { User.class, RmAccountPointApplication.class, BooleanAttributeConverter.class})
