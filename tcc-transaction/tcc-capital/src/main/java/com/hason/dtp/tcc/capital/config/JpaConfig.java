...
import com.hason.dtp.tcc.capital.TccCapitalApplication;
 ...
 */
@Configuration
@EntityScan(basePackageClasses = { User.class, TccCapitalApplication.class, BooleanAttributeConverter.class})
